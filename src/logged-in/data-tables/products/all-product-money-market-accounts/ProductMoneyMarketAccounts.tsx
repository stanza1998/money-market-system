...
import MoneyMarketAccountModel from '../../../../shared/models/MoneyMarketAccount';
...
const ProductMoneyMarketAccounts = observer((props:IProps) => {
  ...
  return (
    <ErrorBoundary>
      <div className="page uk-section uk-section-small uk-width-1-1">
...
export default ProductMoneyMarketAccounts;