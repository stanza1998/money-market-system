...
export const ProductsGrid = observer(({ data }: IProps) => {
          ...
          renderCell: (params) => (
            <div>
              <IconButton
                ...
                onClick={() => onViewInstruments(params.row.key, store)}
              >
                <TaskAltIcon />
              </IconButton>

              <IconButton
                data-uk-tooltip="Daily Flows"
                onClick={() => onViewInstruments(params.row.key, store)}
              >
                <CalendarViewDayIcon />
              </IconButton>
              ...
              <IconButton
                ...
                onClick={() => onUpdateRate(params.row.key, store)}
              >
        ...
        <Modal modalId={MODAL_NAMES.BACK_OFFICE.UPDATE_PRODUCT_BASE_RATE_MODAL}>
          {
            <UpdateProductBaseRateModal
              accounts={productAccounts ? productAccounts : []}
            />
          }
        </Modal>
      </div>
