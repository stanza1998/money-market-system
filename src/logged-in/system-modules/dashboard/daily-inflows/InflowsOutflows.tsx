...
import IndividualInflowTransactionsModal from "../../../dialogs/views/IndividualInflowTransactionsModal";
...
import { WithdrawalCorporateModal } from "../../../dialogs/transactions/withdrawal-from-asset-manager/WithdrawalCorporateModal";
...
const InflowsOutflows = () => {
  ...
  return (
    <ErrorBoundary>
      <div className="uk-overflow-auto" style={{overflow:"scroll"}}>
        ...
        >
          ...
          <tbody>
            <tr>
              <td>Individual</td>
              <td>{currencyFormat(individualInflowsTotalAmount)}</td>
              <td>{currencyFormat(individualOutflowsTotalAmount)}</td>
              <td>{currencyFormat(individualNetTotalAmount)}</td>
              {hasAssetManagerFlowPermission && (
                <td>
                  <>
            ...
            <tr>
              <td>Corporate</td>
              <td>{currencyFormat(corporateInflowsTotalAmount)}</td>
              <td>{currencyFormat(corporateInflowsTotalAmount)}</td>
              <td>{currencyFormat(corporateNetTotalAmount)}</td>
            ...
            <tr>
              ...
              <td>{currencyFormat(taxFreeInflowTotalAmount)}</td>
              <td>{currencyFormat(taxFreeOutflowsTotalAmount)}</td>
              <td>{currencyFormat(taxFreeNetTotalAmount)}</td>
            ...
            <tr>
              ...
              <td>
                <b>{currencyFormat(totalInflowSum)}</b>
              </td>
              <td>
                <b>{currencyFormat(totalOutflowSum)}</b>
              </td>
              <td>
                <b>{currencyFormat(netFlowSum)}</b>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <Modal modalId={MODAL_NAMES.INFLOWS.INDIVIDUAL_INFLOW_TRANSACTIONS_MODAL}>
        <IndividualInflowTransactionsModal transactions={individualInflows} />
      </Modal>
      ...
      >
        <WithdrawalCorporateModal
          inflows={corporateInflowsTotalAmount}
          outflows={corporateOutflowsTotalAmount}
          netflow={corporateNetTotalAmount}
          transactions={corporateOutflows}
        />
      </Modal> */}
      <Modal
        modalId={
