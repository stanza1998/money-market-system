...
import { IBondPurchaseAllocation } from '../../../../../../shared/models/purchases/bonds/BondPurchaseAllocationModel';

type ValidFieldNames = keyof IBondPurchaseAllocation;
...
interface IProps {
  ...
  columnVisibility: { [key in keyof IBondPurchaseAllocation]: boolean };
  handleColumnVisibilityChange: (event: ChangeEvent<HTMLInputElement>) => void;
  BondColumnNames: { [key in keyof IBondPurchaseAllocation]: string };
}

export const TreasuryBillSavedTenderSheetItem = observer((props: IProps) => {
  const {
    index,
    clientName,
  ...
  return (
    ...
    {columnVisibility.maturingNominal &&
        <td>
            ...
            <NumberInput
                ...
                onChange={(value) => onNumberChange(value, index, 'maturingNominal')}
                disabled
            />
    ...
    {columnVisibility.altTreasuryBill && (
        <td>
            ...
            >
                <option  disabled defaultValue={'No'}>Select...</option>
