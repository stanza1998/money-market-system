...
import { faArrowLeft, faEyeSlash } from "@fortawesome/free-solid-svg-icons";import swal from "sweetalert";
      ...
      if (edit) {
        if (periodReplacementInstrument) {
          try {
            ...
            api.instruments.treasuryBill.update(_tb);
            try {
        ...
        onNavigate(`/c/purchases/submitted/${treasuryBill.id}`);
      } else {
        swal({
    ...
    <div className="purchases-view-page uk-section uk-section-small" style={{overflowY:"auto", height:"100vh"}}>
      <div className="uk-container uk-container-expand">
        ...
        <div className="sticky-top uk-margin-bottom">
          <h4 className="main-title-small">Check TB Purchase Allocation (New)</h4>
              ...
              <table className="kit-table uk-table uk-table-small uk-table-responsive uk-table-divider">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{dateFormat(treasuryBill.issueDate)}</td>
                  </tr>
                  <tr>
                    <td className="uk-text-bold">Maturity Date</td>
                    <td>{dateFormat(treasuryBill.maturityDate)}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>{treasuryBill.daysToMaturity}</td>
                  </tr>
                </tbody>
              </table>
            </div>
