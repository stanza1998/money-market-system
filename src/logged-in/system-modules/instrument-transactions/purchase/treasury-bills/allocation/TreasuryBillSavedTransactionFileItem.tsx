...
import { ITreasuryBillPurchaseTransaction } from '../../../../../../shared/models/purchases/treasury-bills/TreasuryBillPurchaseTransactionModel';
import NumberInput from '../../../../../shared/number-input/NumberInput';



type ValidFieldNames = keyof ITreasuryBillPurchaseTransaction;
...
interface IProps {
  ...
  columnVisibility: { [key in keyof ITreasuryBillPurchaseTransaction]: boolean };
  handleColumnVisibilityChange: (event: ChangeEvent<HTMLInputElement>) => void;
  TreasuryBillColumnNames: { [key in keyof ITreasuryBillPurchaseTransaction]: string };
}

export const TreasuryBillSavedTransactionTableItem = (props: IProps) => {
  const {
    index,
    clientName,
