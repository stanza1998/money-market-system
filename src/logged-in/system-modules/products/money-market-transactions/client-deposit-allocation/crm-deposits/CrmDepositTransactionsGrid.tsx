...
import { ICrmClientDepositAllocation } from "../../../../../../shared/models/crm-client-deposit-allocation/CrmClientDepositAllocationModel";

interface IProps {
  data: ICrmClientDepositAllocation[];
}

export const CrmDepositTransactionsGrid = observer(({ data }: IProps) => {
  ...
  const viewTransaction = (deposit: ICrmClientDepositAllocation) => {
    store.crmClientDepositAllocation.select(deposit);
