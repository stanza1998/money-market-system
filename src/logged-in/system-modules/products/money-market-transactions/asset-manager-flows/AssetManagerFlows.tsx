        ...
        <div className="uk-grid uk-grid-small">
                ...
                <table className="uk-table uk-table-small uk-table-divider table-kit">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{numberFormat(individual[0]?.asJson.netflows)}</td>
                      <td>
                        {numberFormat(individual[0]?.asJson.depositAmount)}
                      </td>
                      <td>
                        {numberFormat(individual[0]?.asJson.withdrawalAmount)}
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="uk-table uk-table-small uk-table-divider table-kit">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {numberFormat(ijgMoneyMarketFund[0]?.asJson.netflows)}
                      </td>
                      <td>
                        {numberFormat(
          ...
          <div className="uk-width-1-4">
            ...
            <div className="uk-grid uk-grid-small" data-uk-grid>
              <div className="uk-width-1-1">
                <div className="page-main-card uk-card uk-card-default uk-card-body">
                  <h4 className="main-title-small">Previous Day (Assets)</h4>
                  <table className="uk-table uk-table-small uk-table-divider table-kit">
                    <thead>
                      <tr>
                        <th>IJG (Assets)</th>
