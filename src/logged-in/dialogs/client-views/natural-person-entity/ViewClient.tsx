...
import MoneyMarketAccounts from "./datatables/money-market-account/MoneyMarketAccounts";
import { useNavigate, useParams } from "react-router-dom";
import ErrorBoundary from "../../../../shared/components/error-boundary/ErrorBoundary";
import Toolbar from "../../../shared/toolbar/Toolbar";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowLeftLong, faChain, faEdit } from "@fortawesome/free-solid-svg-icons";
                        ...
                        <ErrorBoundary>
                            <Toolbar
                                leftControls={
                                    ...
                                    <h3 className="main-title-lg">{client?.asJson.entityDisplayName || `${client?.asJson.clientName} ${client?.asJson.clientSurname}`}</h3>
