...
import { faLegal, faUser } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="custom-modal-style uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-width-1-3">
            ...
            <div className="dialog-content uk-position-relative uk-align-center uk-text-center">
                <div className="uk-grid uk-grid-small uk-child-width-1-2" data-uk-grid>
                    <div>
                        <button className="btn btn-primary uk-text-center" onClick={naturalPersonEntity}>
                            <FontAwesomeIcon className="uk-margin-small-right" icon={faUser} />Natural Person
                        </button>
                    </div>
                    <div>
                        <button className="btn btn-primary uk-text-center" onClick={legalEntity}>
                            <FontAwesomeIcon className="uk-margin-small-right" icon={faLegal} /> Legal/Company
                        </button>
                    </div>
                </div>
            </div>
