...
import { generateNextValueWithIncrement, generateNextValue } from "../../../../shared/utils/utils";
...
const EntityImportForm = observer(() => {
  ...
  const handleEntityImport = async () => {
    if (importFile) {
      ...
      const importDataAsJson: INaturalPerson[] = data.map((client: INaturalPersonImport, index) => ({
        ...
        oldCPNumber: `${client.entityOldCPNumber}`,
        entityDisplayName: `${client.clientFirstName} ${client.clientMiddleName} ${client.clientSurname}`,
        clientName: `${client.clientFirstName} ${client.clientMiddleName}` || "",
        ...
        dateDeactivated: client.dateCreated || "string",
...
export default EntityImportForm
