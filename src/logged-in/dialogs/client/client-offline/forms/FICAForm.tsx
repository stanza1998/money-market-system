...
export const FICA = observer((props: IProps) => {
    const { client, setClient, onSubmitFICA, onBackToBankDetail } = props;
                ...
                <div className="uk-width-1-2">
                    ...
                    <div className="uk-form-controls">
                        <input
                            ...
                            id="dateOfLastFIA"
                            type="date"
                            value={client.dateOfLastFIA}
                            onChange={(e) => setClient({ ...client, dateOfLastFIA: e.target.value })}
                            required
                        />
                    </div>
                </div>
                <div className="uk-width-1-2">
                    ...
                    <div className="uk-form-controls">
                        <input
                            ...
                            id="dateOfNextFIA"
                            type="date"
                            value={client.dateOfNextFIA}
                            onChange={(e) => setClient({ ...client, dateOfNextFIA: e.target.value })}
                            required
                        />
                    </div>
                </div>
