...
import { CountryList, NamibiaRegionList } from "../../../../../shared/functions/FormHelpers";
...
export const ContactDetailsForm = observer((props: IContactDetailsFormProps) => {
    const { client, clientDocfoxData, setClient, onSubmitContactDetail, onBackToPersonalDetail } = props;
