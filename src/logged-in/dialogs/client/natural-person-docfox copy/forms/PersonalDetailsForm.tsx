...
export const PersonalDetailsForm = (props: IPersonalDetailsFormProps) => {
    const { client, setClient, clientDocfoxData, onSubmitPersonalDetail, onCancel } = props;
    ...
    return (
        <ErrorBoundary>
            <form className="uk-form-stacked uk-grid-small" data-uk-grid onSubmit={onSubmitPersonalDetail}>
                {/** Client Type*/}
