...
import "./DailyPrincingUpload.scss";
      ...
      <div className="uk-width-1-1 uk-margin" data-uk-margin>
        ...
        }
        {
          ...
          <>
            ...
            <ProgressBar totalItems={productPrices.length} completedItems={completedItems} />
          </>
        ...
        }
        {
          ...
          <>
            ...
            <ProgressBar totalItems={bondPrices.length} completedItems={completedBondItems} />
          </>
        }
