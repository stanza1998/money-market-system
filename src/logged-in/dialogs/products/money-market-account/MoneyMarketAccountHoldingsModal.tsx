...
const MoneyMarketAccountHoldingsModal = observer(() => {
  ...
  return (
    <div className="custom-modal-style uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      <button
        ...
        data-uk-close
      ></button>
      <h3 className="uk-modal-title text-to-break">Money Market Account Holdings</h3>
...
export default MoneyMarketAccountHoldingsModal;
