...
const ClientUserModal = observer(() => {
  ...
  }, [api.client.legalEntity, api.client.naturalPerson, store.user.selected]);

  return (
    <div className="custom-modal-style uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-width-1-2@m uk-width-1-1@s">
      <button
      ...
      <div className="dialog-content uk-position-relative">
        <form
          ...
          <div className="uk-width-1-1@m uk-width-1-1@s ">
            <ClientUserForm user={user} setUser={setUser} />
          </div>
