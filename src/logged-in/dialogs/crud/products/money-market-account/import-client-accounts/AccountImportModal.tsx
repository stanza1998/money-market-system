...
import EntityImportForm from "./AccountImportForm";
import { hideModalFromId } from "../../../../../../shared/functions/ModalShow";
import MODAL_NAMES from "../../../../ModalName";
import AccountImportForm from "./AccountImportForm";

const AccountImportModal = observer(() => {
  const onCancel = () => {
    ...
    <div className="upload-deduction-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <div className="dialog-content uk-position-relative">
        <form
          ...
          data-uk-grid
        >
          <p>This form allows you to import <b>Client Account</b> excel files that have been exported from the old system.</p>
          <AccountImportForm/>
