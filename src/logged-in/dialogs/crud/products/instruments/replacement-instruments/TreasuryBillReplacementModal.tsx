...
const TreasuryBillReplacementModal = observer(() => {
    ...
    const onCancel = () => {
        ...
        hideModalFromId(MODAL_NAMES.ADMIN.TREASURY_BILL_REPLACEMENT_MODAL);
    };
    ...
    useEffect(() => {
        ...
        getIssuer();
    }, [api.issuer, store.instruments.treasuryBill.selected]);
...
export default TreasuryBillReplacementModal;
