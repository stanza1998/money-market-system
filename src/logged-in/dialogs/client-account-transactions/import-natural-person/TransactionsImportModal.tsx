...
const TransactionsImportModal = observer(() => {
  const onCancel = () => {
    ...
    <div className="upload-deduction-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <div className="dialog-content uk-position-relative">
        <form
          ...
          data-uk-grid
        >
          <p>This form allows you to import <b>Transactions</b> from excel files that have been exported from the old system.</p>
