...
import { ICrmClientDepositAllocation, defaultCrmClientDepositAllocation } from "../../../../shared/models/crm-client-deposit-allocation/CrmClientDepositAllocationModel";
...
const DepositModal = observer(() => {
  ...
  const [newClientDepositAllocation, setNewClientDepositAllocation] =
    useState<ICrmClientDepositAllocation>({ ...defaultCrmClientDepositAllocation });
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const saveTransaction: ICrmClientDepositAllocation = {
      ...defaultCrmClientDepositAllocation,
      entity: entityId,
  ...
  console.log("created transaction", saveTransaction);
    ...
    setNewClientDepositAllocation({ ...defaultCrmClientDepositAllocation });
  };

  const create = async (transaction: ICrmClientDepositAllocation) => {
    try {
      await api.crmClientDepositAllocation.create(transaction);
      swal({
        icon: "success",
  ...
  const onCancel = () => {
    ...
    setEntityId("");
    setNewClientDepositAllocation({ ...defaultCrmClientDepositAllocation });
    hideModalFromId(MODAL_NAMES.DEPOSIT_MODAL);
    setLoading(false);
  };
  ...
  const toggleDarkMode = () => {
    ...
    document.body.classList.toggle("dark-mode-variables", newMode);
        ...
        <div className="dialog-content uk-position-relative">
          <form className="uk-grid" data-uk-grid onSubmit={handleSubmit}>
            ...
            <div className="uk-grid uk-grid-small uk-grid-match uk-child-width-1-3 uk-width-1-1">
              <div className="uk-child-width-1-3 uk-width-1-1-mobile">
            ...
            <div className="uk-form-controls">
              ...
              <button
                ...
                Deposit {loading && <div data-uk-spinner={"ratio:.5"}></div>}
              </button>
            </div>
          </form>
        </div>
