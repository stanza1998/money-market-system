...
var InflationLinkedBond = /** @class */ (function (_super) {
    ...
    InflationLinkedBond.prototype.inflationAdjustedPrice = function (settlementDate, yieldToMaturity, NCPIIndex) {
        ...
        var formattedFourMonthsAgoDate = formatDateKey(EOMThreeMonthsAgo);
        var NCPFIFourMonthsAgo = NCPIIndex[formattedFourMonthsAgoDate];
        ...
        var referenceCPI = NCPFIFourMonthsAgo + ((dayOfMonth - 1) / daysInMonth) * (NCPIThreeMonthsAgo - NCPFIFourMonthsAgo);
...
// Bond Static Data
var GC23 = new Bond(8.85, new Date(2023, 9, 15), 2, 31);
var GC24 = new Bond(10.5, new Date(2024, 9, 15), 2, 31);
...
var GI25 = new InflationLinkedBond(3.8, new Date(2025, 6, 15), 2, 31, 111.819909583916);
...
var settlementDate = new Date(2024, 3, 16);
