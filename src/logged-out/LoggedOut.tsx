        ...
        <div className="uk-grid">
          ...
          <div className="uk-width-1-4">
            ...
            <div className="login uk-card uk-card-body">
              <h4 className="main-title-small">System User Login</h4>
              <form className="uk-form-stacked uk-child-width-3-4" onSubmit={onSignIn}>
                ...
                <div className="uk-margin uk-inline">
                  ...
                  <div className="uk-form-controls">
                    <input className={`uk-input ${userNotFoundError ? 'uk-input-invalid' : ''}`} id="user-login-password" type="password" placeholder="Password"
